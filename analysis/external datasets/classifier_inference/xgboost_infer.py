...
# CONFIGURATION
# ============================================================================
MODEL_JSON_PATH = 'xgb_best_model.json'
MODEL_METADATA_PATH = 'xgb_best_model.pickle'
...
for key, value in params.items():
    if key != 'early_stopping_rounds':  # Skip non-model params
        print(f"  {key}: {value}")
...
plt.title('Confusion Matrix - XGBoost Model on External Test Set')
plt.tight_layout()
plt.savefig('xgb_confusion_matrix_external_test.png', dpi=300, bbox_inches='tight')
print("\nConfusion matrix saved to: xgb_confusion_matrix_external_test.png")
...
# Get feature importance (use 'weight' as importance type)
...
importance_df.plot(x='feature', y='importance', kind='barh', ax=ax, legend=False, color='orange')
ax.set_xlabel('Feature Importance')
ax.set_ylabel('Feature')
ax.set_title('XGBoost Feature Importance')
plt.tight_layout()
plt.savefig('xgb_feature_importance.png', dpi=300, bbox_inches='tight')
print("\nFeature importance plot saved to: xgb_feature_importance.png")

# ============================================================================
# PREDICTION CONFIDENCE ANALYSIS (XGBoost specific)
# ============================================================================
print("\n" + "="*70)
...
axes[0].hist(prediction_confidences, bins=30, alpha=0.7, color='orange', edgecolor='black')
...
plt.tight_layout()
plt.savefig('xgb_confidence_analysis.png', dpi=300, bbox_inches='tight')
print("\nConfidence analysis plot saved to: xgb_confidence_analysis.png")
...
# Save to CSV
output_path = 'xgb_predictions_external_test.csv'
