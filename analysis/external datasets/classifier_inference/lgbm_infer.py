...
# CONFIGURATION
# ============================================================================
MODEL_PICKLE_PATH = 'lgbm_best_model_complete.pickle'
MODEL_METADATA_PATH = 'lgbm_best_model.pickle'
...
for key, value in params.items():
    if key not in ['early_stopping_rounds', 'verbose']:  # Skip non-model params
        print(f"  {key}: {value}")
...
plt.title('Confusion Matrix - LightGBM Model on External Test Set')
plt.tight_layout()
plt.savefig('lgbm_confusion_matrix_external_test.png', dpi=300, bbox_inches='tight')
print("\nConfusion matrix saved to: lgbm_confusion_matrix_external_test.png")

# ============================================================================
# FEATURE IMPORTANCE (LightGBM specific)
# ============================================================================
print("\n" + "="*70)
print("FEATURE IMPORTANCE")
print("="*70)

# Get feature importance (use 'split' as importance type)
...
importance_df.plot(x='feature', y='importance', kind='barh', ax=ax, legend=False, color='teal')
ax.set_xlabel('Feature Importance')
ax.set_ylabel('Feature')
ax.set_title('LightGBM Feature Importance')
plt.tight_layout()
plt.savefig('lgbm_feature_importance.png', dpi=300, bbox_inches='tight')
print("\nFeature importance plot saved to: lgbm_feature_importance.png")

# ============================================================================
# PREDICTION CONFIDENCE ANALYSIS (LightGBM specific)
# ============================================================================
print("\n" + "="*70)
...
axes[0].hist(prediction_confidences, bins=30, alpha=0.7, color='teal', edgecolor='black')
...
plt.tight_layout()
plt.savefig('lgbm_confidence_analysis.png', dpi=300, bbox_inches='tight')
print("\nConfidence analysis plot saved to: lgbm_confidence_analysis.png")
...
# Save to CSV
output_path = 'lgbm_predictions_external_test.csv'
