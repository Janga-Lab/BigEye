...
# CONFIGURATION
# ============================================================================
MODEL_PATH = 'svm_best_model.pickle'
TEST_DATA_PATH = 'fqm_una_with_lesions.csv'
...
plt.title('Confusion Matrix - SVM Model on External Test Set')
plt.tight_layout()
plt.savefig('svm_confusion_matrix_external_test.png', dpi=300, bbox_inches='tight')
print("\nConfusion matrix saved to: svm_confusion_matrix_external_test.png")
...
# Save to CSV
output_path = 'svm_predictions_external_test.csv'
