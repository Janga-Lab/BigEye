...
# CONFIGURATION
# ============================================================================
MODEL_H5_PATH = 'nn_best_model.h5'
MODEL_METADATA_PATH = 'nn_best_model.pickle'
...
plt.title('Confusion Matrix - Neural Network Model on External Test Set')
plt.tight_layout()
plt.savefig('nn_confusion_matrix_external_test.png', dpi=300, bbox_inches='tight')
print("\nConfusion matrix saved to: nn_confusion_matrix_external_test.png")

# ============================================================================
# PREDICTION CONFIDENCE ANALYSIS (Neural Network specific)
# ============================================================================
print("\n" + "="*70)
...
axes[0].hist(prediction_confidences, bins=30, alpha=0.7, color='purple', edgecolor='black')
...
plt.tight_layout()
plt.savefig('nn_confidence_analysis.png', dpi=300, bbox_inches='tight')
print("\nConfidence analysis plot saved to: nn_confidence_analysis.png")
...
# Save to CSV
output_path = 'nn_predictions_external_test.csv'
