...
for outer_fold, (inner_idx, outer_idx) in enumerate(outer_kf.split(data, labels_int)):
    ...
    for inner_fold, (train_idx, val_idx) in enumerate(inner_kf.split(inner_data, inner_labels)):
        ...
        # Get probability predictions for AUC and log_loss
        ...
        auc = safe_roc_auc_score(y_train_int, p_proba, num_classes)
        ...
        # CRITICAL FIX: Pass probabilities to AUC calculation
        auc = safe_roc_auc_score(y_val_int, p_proba, num_classes)
        ...
        # CRITICAL FIX: Pass probabilities to AUC calculation
        auc = safe_roc_auc_score(y_test_int, p_proba, num_classes)
